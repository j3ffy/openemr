CREATE TABLE `form_ros` (
	...
	`weight_loss` varchar(3) NOT NULL default 'N/A',
	`weight_gain` varchar(3) NOT NULL default 'N/A',
	...
	`sleep_problems` varchar(3) NOT NULL default 'N/A',
	...
	`drainage` varchar(3) NOT NULL default 'N/A',
